...
export default class AvaTaxClient {
  ...
  restCall({ url, verb, payload, clientId="" }) {
    return withTimeout(1200000, fetch(url, {
      ...
      var contentLength = res.headers._headers['content-length'][0];
   ...
   * @return object
   */
  createTransactionBatch({ companyId, model } = {}) {
    var path = this.buildUrl({
   ...
   * @return object[]
   */
  createCompanyParameters({ companyId, model } = {}) {
    var path = this.buildUrl({
   ...
   * @return object[]
   */
  deleteCompanyParameter({ companyId, id } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  getCompanyParameterDetail({ companyId, id } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/parameters/${id}`,
      parameters: {}
    });
   ...
   * @return FetchResult
   */
  listCompanyParameterDetails({ companyId, filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/parameters`,
      parameters: {
        $filter: filter,
   ...
   * @return object
   */
  updateCompanyParameterDetail({ companyId, id, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/parameters/${id}`,
      parameters: {}
    });
   ...
   * @return FetchResult
   */
  listContactsByCompany({ companyId, filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/contacts`,
      parameters: {
        $filter: filter,
   ...
   * @return FetchResult
   */
  queryContacts({ filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/contacts`,
      parameters: {
        $filter: filter,
   ...
   * @return FetchResult
   */
  linkAttributesToCustomer({ companyId, customerCode, model } = {}) {
    var path = this.buildUrl({
   ...
   * @return FetchResult
   */
  listAttributesForCustomer({ companyId, customerCode } = {}) {
    var path = this.buildUrl({
   ...
   * @return FetchResult
   */
  unlinkAttributesFromCustomer({ companyId, customerCode, model } = {}) {
    var path = this.buildUrl({
   ...
   * @return FetchResult
   */
  listClassificationParametersUsage({ filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
   ...
   * @return FetchResult
   */
  listJurisdictionsByRateTypeTaxTypeMapping({ country, region, taxTypeId, taxSubTypeId, rateTypeId, filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/definitions/jurisdictions/countries/${country}/regions/${region}/taxtypes/${taxTypeId}/taxsubtypes/${taxSubTypeId}`,
      parameters: {
   ...
   * @return FetchResult
   */
  listMarketplaceLocations({ marketplaceId, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
   ...
   * @return FetchResult
   */
  listNexusByTaxTypeGroup({ taxTypeGroup, filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
   ...
   * @return FetchResult
   */
  listParametersUsage({ filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
   ...
   * @return FetchResult
   */
  listProductClassificationSystems({ filter, top, skip, orderBy, countryCode } = {}) {
    var path = this.buildUrl({
   ...
   * @return FetchResult
   */
  listProductClassificationSystemsByCompany({ companyCode, filter, top, skip, orderBy, countryCode } = {}) {
    var path = this.buildUrl({
   ...
   * @return FetchResult
   */
  listRateTypesByCountryTaxTypeTaxSubType({ country, taxTypeId, taxSubTypeId, filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
   ...
   * @return FetchResult
   */
  listReturnsParametersUsage({ filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
   ...
   * @return FetchResult
   */
  listTags({ filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
   ...
   * @return FetchResult
   */
  listTaxSubTypesByCountryAndTaxType({ country, taxTypeId, filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
   ...
   * @return FetchResult
   */
  listTaxSubTypesByJurisdictionAndRegion({ jurisdictionCode, region, filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
   ...
   * @return FetchResult
   */
  listTaxTypesByNexusAndCountry({ country, companyId, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
   ...
   * @return FetchResult
   */
  listUnitOfBasisByCountryAndTaxTypeAndTaxSubTypeAndRateType({ country, taxTypeId, taxSubTypeId, rateTypeId, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  createECommerceToken({ companyId, model } = {}) {
    var path = this.buildUrl({
   ...
   * @return FetchResult
   */
  refreshECommerceToken({ companyId, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/ecommercetokens`,
      parameters: {}
    });
   ...
   * 
     ...
     * @param object model Cycle Safe Options Request
   * @return object
   */
  cycleSafeOptions({ companyId, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/filingcalendars/edit/cycleSafeOptions`,
      parameters: {}
    });
	 var strClientId =
      this.appNM +
   ...
   * @return object[]
   */
  deleteCompanyReturnSettings({ companyId, filingCalendarId, companyReturnSettingId } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/filingcalendars/${filingCalendarId}/setting/${companyReturnSettingId}`,
      parameters: {}
    });
	 var strClientId =
      this.appNM +
   ...
   * @return FetchResult
   */
  legacyFilingCalendars({ companyId, filter, top, skip, orderBy, returnCountry, returnRegion } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/filingcalendars/Legacy`,
      parameters: {
        $filter: filter,
        $top: top,
        $skip: skip,
   ...
   * @return FetchResult
   */
  getAccrualFilings({ companyId, filingReturnId } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/filings/accrual/${filingReturnId}`,
      parameters: {}
    });
	 var strClientId =
      this.appNM +
   ...
   * @return object
   */
  createAndLinkNewFirmClientAccount({ model } = {}) {
    var path = this.buildUrl({
   ...
   * @return object[]
   */
  batchDeleteItemClassifications({ companyId, itemId } = {}) {
    var path = this.buildUrl({
   ...
   * @return object[]
   */
  batchDeleteItemParameters({ companyId, itemId } = {}) {
    var path = this.buildUrl({
   ...
   * 
     ...
     * @param object model The items you wish to upload.
   * @return object
   */
  bulkUploadItems({ companyId, model } = {}) {
    var path = this.buildUrl({
   ...
   * 
     ...
     * @param object[] model Tags you wish to associate with the Item
   * @return object[]
   */
  createItemTags({ companyId, itemId, model } = {}) {
    var path = this.buildUrl({
   ...
   * @return object[]
   */
  deleteItemTag({ companyId, itemId, itemTagDetailId } = {}) {
    var path = this.buildUrl({
   ...
   * @return object[]
   */
  deleteItemTags({ companyId, itemId } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/items/${itemId}/tags`,
      parameters: {}
    });
   ...
   * @return FetchResult
   */
  getItemTags({ companyId, itemId, filter, top, skip } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/items/${itemId}/tags`,
      parameters: {
        $filter: filter,
   ...
   * @return FetchResult
   */
  queryItemsByTag({ companyId, tag, filter, include, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
   ...
   * @return object[]
   */
  createLocationParameters({ companyId, locationId, model } = {}) {
    var path = this.buildUrl({
   ...
   * @return object[]
   */
  deleteLocationParameter({ companyId, locationId, id } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  getLocationParameter({ companyId, locationId, id } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/locations/${locationId}/parameters/${id}`,
      parameters: {}
    });
   ...
   * @return FetchResult
   */
  listLocationParameters({ companyId, locationId, filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/locations/${locationId}/parameters`,
      parameters: {
        $filter: filter,
   ...
   * @return object
   */
  updateLocationParameter({ companyId, locationId, id, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/locations/${locationId}/parameters/${id}`,
      parameters: {}
    });
   ...
   * @return object[]
   */
  createNexusParameters({ companyId, nexusId, model } = {}) {
    var path = this.buildUrl({
   ...
   * @return object[]
   */
  deleteNexus({ companyId, id, cascadeDelete } = {}) {
    var path = this.buildUrl({
   ...
   * @return object[]
   */
  deleteNexusParameter({ companyId, nexusId, id } = {}) {
    var path = this.buildUrl({
   ...
   * @return object[]
   */
  deleteNexusParameters({ companyId, nexusId } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/nexus/${nexusId}/parameters`,
      parameters: {}
    });
   ...
   * @return object
   */
  getNexusByFormCode({ companyId, formCode, include } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  getNexusParameter({ companyId, nexusId, id } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/nexus/${nexusId}/parameters/${id}`,
      parameters: {}
    });
   ...
   * @return FetchResult
   */
  listNexusByCompanyAndTaxTypeGroup({ companyId, taxTypeGroup, filter, include, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
   ...
   * @return FetchResult
   */
  listNexusParameters({ companyId, nexusId, filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/nexus/${nexusId}/parameters`,
      parameters: {
        $filter: filter,
   ...
   * @return object
   */
  updateNexusParameter({ companyId, nexusId, id, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/nexus/${nexusId}/parameters/${id}`,
      parameters: {}
    });
   ...
   *
   * 
     * @param object model The responsibility type to create
   * @return object
   */
  createNoticeResponsibilityType({ model } = {}) {
    var path = this.buildUrl({
   ...
   *
   * 
     * @param object model The root cause type to create
   * @return object
   */
  createNoticeRootCauseType({ model } = {}) {
    var path = this.buildUrl({
   ...
   * @return object[]
   */
  deleteNoticeResponsibilityType({ responsibilityId } = {}) {
    var path = this.buildUrl({
   ...
   * @return object[]
   */
  deleteNoticeRootCauseType({ rootCauseId } = {}) {
    var path = this.buildUrl({
   ...
   * @return FetchResult
   */
  listReports({ companyId, pageKey, skip, top } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/reports`,
      parameters: {
        companyId: companyId,
   ...
   * @return object
   */
  adjustTransaction({ companyCode, transactionCode, documentType, include, model } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  changeTransactionCode({ companyCode, transactionCode, documentType, include, model } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  commitTransaction({ companyCode, transactionCode, documentType, include, model } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  lockTransaction({ companyCode, transactionCode, documentType, include, model } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  settleTransaction({ companyCode, transactionCode, documentType, include, model } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  uncommitTransaction({ companyCode, transactionCode, documentType, include } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  unvoidTransaction({ companyCode, transactionCode, documentType, include } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  verifyTransaction({ companyCode, transactionCode, documentType, include, model } = {}) {
    var path = this.buildUrl({
   ...
   * 
     ...
     * @param object model Information about the individual whose age is being verified.
   * @return object
   */
  verifyAge({ simulatedFailureCode, model } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  decrecatedVerifyShipment({ companyCode, transactionCode, documentType } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyCode}/transactions/${transactionCode}/shippingverify`,
      parameters: {
        documentType: documentType
      }
    });
   ...
   * @return object
   */
  registerShipmentIfCompliant({ companyCode, transactionCode, documentType } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  verifyShipment({ companyCode, transactionCode, documentType } = {}) {
    var path = this.buildUrl({
